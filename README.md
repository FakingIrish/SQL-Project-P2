...
# OPTION 2: ALTER CUSTOMERS ORIGINAL SQL BY ADDING EXTRA SECONDARY PHONE NUMBER COLUMN (AS SHOWN ABOVE), THEN ALTER PHONE VARCHAR LENGTHS TO HANDLE INTERNATIONAL NUMBERS 
